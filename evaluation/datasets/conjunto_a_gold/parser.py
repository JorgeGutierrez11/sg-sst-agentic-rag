"""
Convierte la hoja "Dataset Conjunto A" de Diseño.xlsx a JSON.
...
SHEET_NAME = "Dataset Conjunto A"
EXCLUDE_COLS = {"Estado"}
OUTPUT_PATH = Path(__file__).resolve().parent / "conjunto_a_gold.json"


def find_header_row(ws):
    """Busca la fila que contiene 'ID' como encabezado."""
...
def main():
    ...
    # Mapear columna -> nombre de encabezado, ignorando celdas vacías/excluidas
    col_map = {}
